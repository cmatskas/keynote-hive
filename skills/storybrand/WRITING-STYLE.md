...
- Follow the Chicago Manual of Style for grammar and punctuation.- Use active voice.- Avoid adjectives and adverbs- Remove intensifiers and qualifiers- Remove redundant words.- Avoid noun stacks.- Don't use the future tense when the present will do.- Use the simplest word for an action, not the common wordy one.- Use powerful vivid verbs.- Avoid excessive nominalization, turning a verb or verb phrase (He recommended) into a noun or noun phrase (His recommendation was to...).- Keep sentences under 40 words.- Spell out acronyms upon first mention.- Write in plain English: avoid arcane, dead, fancy, and inflated terms.- Avoid industry-speak, buzzwords, overused words and phrases.- Use a conversational and personal voice instead of a disembodied, impersonal one.- Don't use exclamation marks.- Use contractions.- Vary sentence structure and length so your sentences flow smoothly and are not stilted or clunky.- Don’t use em dashes- don’t use bullet points, write in complete paragraphs.
